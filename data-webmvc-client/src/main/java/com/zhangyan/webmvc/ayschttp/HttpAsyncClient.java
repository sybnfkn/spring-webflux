...
public class HttpAsyncClient {
    ...
    private static int socketTimeout = 500;// 设置等待数据超时时间5秒钟 根据业务调整

    private static int connectTimeout = 200;// 连接超时

    private static int poolSize = 300;// 连接池最大连接数

    private static int maxPerRoute = 150;// 每个主机的并发最多只有1500，如果后端保有一台应用机就配置3000
